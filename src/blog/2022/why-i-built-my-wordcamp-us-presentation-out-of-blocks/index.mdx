...
<Image src="./custom-blocks-number-of-blocks.jpg" alt="The presentation was composed of 749 individual blocks that make up 21 slides." width={900} height={489} caption={<>The presentation was composed of 749 individual blocks that make up 21 slides.</>} />
...
<Image src="./custom-blocks-structure.jpg" alt="The general structure of each slide." width={1350} height={675} caption={<>The general structure of each slide.</>} />
...
<Image src="./custom-blocks-anchor-links.jpg" alt="The anchor links for each slide are visible in the List View." width={900} height={560} caption={<>The anchor links for each slide are visible in the List View.</>} />
...
<Image src="./custom-blocks-visibility.jpg" alt="Block Visibility was used to conditionally display notices and schedule the presentation." width={1350} height={720} caption={<>[Block Visibility](https://wordpress.org/plugins/block-visibility/) was used to conditionally display notices and schedule the presentation.</>} />
