...
<Image src="./user-role-screenshot.jpg" alt="" width={1000} height={583} caption={<>Restrict visibility to all logged-in users with the [Block Visibility](https://wordpress.org/plugins/block-visibility/) plugin.</>} />
...
<Image src="./user-role-advanced-screenshot.jpg" alt="Restrict visibility to Administrators and Editors with the Block Visibility plugin." width={1000} height={580} caption={<>Restrict visibility to Administrators and Editors with the [Block Visibility](https://wordpress.org/plugins/block-visibility/) plugin.</>} />
...
<Image src="./hide-block-screenshot.jpg" alt="Hide any block using the Block Visibility plugin." width={1000} height={547} caption={<>Hide any block using the [Block Visibility](https://wordpress.org/plugins/block-visibility/) plugin.</>} />
